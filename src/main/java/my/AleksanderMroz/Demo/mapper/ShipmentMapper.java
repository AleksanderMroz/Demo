...
public class ShipmentMapper {
    ...
    public static ShipmentTo map(ShipmentEntity shipmentEntity) {
        if (shipmentEntity != null) {
            return new ShipmentTo(shipmentEntity.getId(),shipmentEntity.getDestination(),shipmentEntity.getValue(),shipmentEntity.getStatus() );
        }
        return null;
    }
    ...
    public static ShipmentEntity map(ShipmentTo shipmentTo) {
        if (shipmentTo != null) {
            return new ShipmentEntity(shipmentTo.getId(), shipmentTo.getDestination(),shipmentTo.getValue(),shipmentTo.getStatus());
        }
        return null;
    }

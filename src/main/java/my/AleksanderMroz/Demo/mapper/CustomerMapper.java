...
//            return new CustomerTo(customerEntity.getId(), customerEntity.getCustomerName(), customerEntity.getPassword(),customerEntity.getAddress(),customerEntity.getShipments());
//        }
//        return null;
//    }
//
...
//    {
//        if (customerTo != null) {
//            return new CustomerEntity(customerTo.getId(), customerTo.getCustomerName(), customerTo.getPassword(),customerTo.getAddress(),customerTo.getShipments());
//        }
//        return null;
//    }
//

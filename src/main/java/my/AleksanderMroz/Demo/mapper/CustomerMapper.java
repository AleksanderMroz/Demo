...
public class CustomerMapper {
    ...
    public static CustomerTo map(CustomerEntity customerEntity)
    {
        if (customerEntity != null) {
            return new CustomerTo(customerEntity.getId(),customerEntity.getCustomerName(),customerEntity.getPassword(),customerEntity.getAddress(),customerEntity.getShipments(),customerEntity.getOpinions());
        }
        return null;
    }
    ...
    {
        if (customerTo != null) {
            return new CustomerEntity(customerTo.getId(),customerTo.getCustomerName(),customerTo.getPassword(),customerTo.getAddress(),customerTo.getShipments(),customerTo.getOpinions());
        }
        return null;
    }
